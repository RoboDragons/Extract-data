    ...
    while not stop_event.is_set(): # スレッドが停止されるまでループ
        try:
            ...
            if balls_position and robot_poji: 
                ...
                if ball_x > 6000:
                    if robot_poji and ((ball_x > poji_goal_x and (goal_top > ball_y > goal_bottom)) or (ball_x < nega_goal_x and (goal_top > ball_y > goal_bottom))): # ゴールシーンの条件
